window.onload = function() {
	...
	if (ctx) {
		...
		//var linGrd = ctx.createLinearGradient(20, 20, 20, 280);  //horizontal
		//var linGrd = ctx.createLinearGradient(20, 20, 220, 280); //diagonal
		var linGrd = ctx.createLinearGradient(20, 20, 220, 20);  //vertical
